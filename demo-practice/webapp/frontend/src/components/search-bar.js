...
class SearchBar extends PolymerElement {
  static get template() {
    ...
    <div class="row">
      ...
      <!--<vaadin-checkbox id="chkbox" class="checkbox desktop" checked="{{checkboxChecked}}" on-focus="_onFieldFocus" 
        on-blur="_onFieldBlur">[[checkboxText]]</vaadin-checkbox>-->
    </div>

    <!--<vaadin-checkbox id="chkbox" class="checkbox mobile" checked="{{checkboxChecked}}" on-focus="_onFieldFocus" 
      on-blur="_onFieldBlur">[[checkboxText]]</vaadin-checkbox>-->
`;
  }
